...
const csp = [
  "default-src 'self'",
  "base-uri 'self'",
  "form-action 'self' https://accounts.bluecrew.no https://*.clerk.accounts.dev https://*.clerk.dev https://*.clerk.com https://clerk.accounts.dev https://clerk.dev https://clerk.com",
  ...
  "connect-src 'self' https://api.resend.com https://*.supabase.co https://*.supabase.net https://*.upstash.io https://plausible.io https://api.vipps.no https://data.brreg.no https://vercel.live https://clerk.bluecrew.no https://accounts.bluecrew.no https://*.clerk.accounts.dev https://*.clerk.dev https://*.clerk.com https://clerk.accounts.dev https://clerk.dev https://clerk.com https://clerk-telemetry.com https://challenges.cloudflare.com",
