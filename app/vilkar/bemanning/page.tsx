...
export default function BemanningVilkarPage() {
  return (
    <main style={ui.main}>
      <h1 style={ui.h1}>Arbeidsvilkår for bemanning</h1>
      <p>
  Disse vilkårene gjelder for bemanningstjenester levert av <strong>Bluecrew AS</strong> (heretter &quot;Bluecrew&quot;, &quot;vi&quot;, &quot;oss&quot;), org.nr. 936463843, til innleiekunder.
      </p>

      <h2>1. Lovgrunnlag og virkeområde</h2>
      <p style={ui.p}>
      ...
      <h2>3. Likebehandlingsprinsippet (AML § 14-12a)</h2>
      <p style={ui.p}>
      ...
      <h2>4. Forsikring og erstatningsansvar</h2>
      <ul style={ui.ul}>
        <li>
      ...
      <h2>5. HMS-ansvar og opplæring</h2>
      <p style={ui.p}>
      ...
      <h2>6. Oppsigelse og varighet</h2>
      <ul style={ui.ul}>
        <li>
