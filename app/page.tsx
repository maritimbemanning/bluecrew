    ...
    <main style={sx.page}>
      ...
      <header style={sx.topbar}>
        <div style={sx.wrap}>
          ...
          <nav style={sx.nav} aria-label="Hovedmeny">
            <a href="#kandidat" style={sx.navLink}>
              Kandidat
            </a>
            <a href="#kunde" style={sx.navLink}>
              Kunde
            </a>
            <a href="#om-oss" style={sx.navLink}>
              Om oss
            </a>
            <a href="#kontakt" style={sx.navLink}>
              Kontakt
            </a>
          </nav>
        </div>
      ...
      <section style={sx.hero}>
        <div style={sx.heroWrap}>
          ...
          <ul style={sx.badges}>
            <li style={sx.badge}>
              <span style={sx.badgeIcon}>🧭</span> Skippere, matroser,
              akvateknikere
            </li>
            <li style={sx.badge}>
              <span style={sx.badgeIcon}>🌊</span> Praktisk erfaring fra sjøen
            </li>
            <li style={sx.badge}>
              <span style={sx.badgeIcon}>⏱️</span> Rask respons & ryddige
              avtaler
            </li>
          </ul>
        </div>
        ...
        <div style={sx.wrapNarrow}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <p style={sx.leadSmall}>
              Bemanning og rekruttering til havbruk, fiskeri og servicefartøy —
              raskt, trygt og ryddig.
            </p>
          </div>
      ...
      <section id="fordeler" style={sx.sectionAlt}>
        <div style={sx.wrapNarrow}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <p style={sx.leadSmall}>
              Vi kombinerer sjøfolkets erfaring med moderne bemanningsprosesser
              for å levere kvalitet fra første kontakt.
            </p>
          </div>
      ...
      <section style={sx.sectionDeep}>
        <div style={sx.wrapNarrow}>
          <div style={sx.sectionDeepIntro}>
            <h2 style={sx.h2Dark}>Maritim beredskap & kvalitet</h2>
            <p style={sx.deepLead}>
              Vi kjenner regelverket for norsk kystfart og sørger for at alle
              utsendte har riktig dokumentasjon, sikkerhetsopplæring og
              oppfølging før, under og etter oppdrag.
            </p>
          </div>

          <div style={sx.assureGrid}>
            {MARITIME_ASSURANCES.map((item) => (
              <article key={item.title} style={sx.assureCard}>
                <div style={sx.assureIcon} aria-hidden="true">
                  {item.icon}
                </div>
                <h3 style={sx.assureTitle}>{item.title}</h3>
                <p style={sx.assureText}>{item.text}</p>
              </article>
            ))}
          </div>

          <div style={sx.complianceBox}>
            <h3 style={sx.complianceTitle}>Dokumentert etterlevelse</h3>
            <ul style={sx.complianceList}>
      ...
      <section id="kandidat" style={sx.section}>
        <div style={sx.wrapNarrow}>
          ...
          <p style={sx.muted}>
            Legg inn kontaktinfo, velg fagområder og last opp CV (PDF). Vi
            kontakter deg når relevant oppdrag dukker opp.
          </p>
          ...
          {sent === "worker" ? (
            ...
            >
                        ...
                        {open && (
                          <div style={{ marginTop: 10 }}>
                            ...
                            <small style={{ color: "#64748b" }}>
                              Velg undervalg (eller fyll “Annet”). Du kan åpne
                              flere hovedkategorier.
                            </small>
                          </div>
                        )}
                      </div>
                ...
                <div>
                  ...
                  {hasSTCW === "ja" && (
                    <div style={{ marginTop: 8 }}>
                      ...
                      >
                        Huk av relevante moduler
                      </div>
                      <div style={sx.checkGrid}>
                        {STCW_MODULES.map((m) => (
                          <label key={m} style={sx.checkItem}>
                            <input type="checkbox" name="stcw_mod" value={m} />{" "}
                            <span>{m}</span>
                          </label>
                        ))}
                      </div>
              ...
              >
                ...
                >
                  Jeg samtykker til behandling av persondata for
      ...
      <section id="kunde" style={{ ...sx.section, background: "#fff" }}>
        <div style={sx.wrapNarrow}>
          ...
          <p style={sx.muted}>
            Beskriv behovet kort – vi matcher kvalifiserte kandidater etter
            kompetanse, tilgjengelighet og lokasjon.
          </p>
      ...
      <section id="om-oss" style={{ ...sx.section, background: "#F8FAFC" }}>
        <div style={sx.wrapNarrow}>
          ...
          <p style={sx.muted}>
            Bluecrew er et norsk bemannings- og rekrutteringsbyrå spesialisert
            innen maritim sektor. Vi leverer kvalifisert personell til havbruk,
            fiskeri og servicefartøy — fra dekk til bro.
          </p>

          <p style={sx.muted}>
            Selskapet drives av sjøfolk med erfaring fra norsk kystfart og
            oppdrettsnæring. Vi vet hva som kreves om bord, og vi vet hvor
            viktig det er med rett kompetanse til rett tid.
          </p>

          <p style={sx.muted}>
            Gjennom et tett samarbeid med både mannskap og rederi sørger vi for
            kvalitet, trygghet og fleksibilitet i alle oppdrag. Våre prosesser
            er enkle, ryddige og tilpasset kravene i norsk maritim drift.
          </p>
      ...
      <section id="kontakt" style={{ ...sx.section, background: "#fff" }}>
        <div style={sx.wrapNarrow}>
          ...
          <p style={sx.muted}>
            Ta kontakt for forespørsel om bemanning, samarbeid eller andre
            henvendelser.
          </p>
          ...
          <div style={sx.privacyBox}>
            <p style={{ margin: 0, fontSize: 14 }}>
              Alle personopplysninger lagres sikkert og brukes kun i forbindelse
              med rekruttering og bemanning. Dokumenter deles ikke med
              tredjepart uten samtykke.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer style={sx.footer}>
        <div style={sx.wrapNarrow}>© {year} Bluecrew AS — Bemanning til sjøs</div>
      </footer>
    </main>
  );
}
...
const MARITIME_ASSURANCES = [
  {
    icon: "📞",
    title: "24/7 vakttelefon",
    text: "Direkte kontakt med bemanningsekspert som følger opp oppstart, avløsing og avreise hele døgnet.",
  },
  {
    icon: "🗂️",
    title: "Dokumentkontroll",
    text: "Sertifikater, helseerklæringer og referanser verifiseres og lagres sikkert i forkant av utsendelse.",
  },
  {
    icon: "🦺",
    title: "HMS-fokus",
    text: "Oppdaterte rutiner for sikker jobb-analyse og rapportering gir trygghet for mannskap og rederi.",
  },
  {
    icon: "🧭",
    title: "Nordnorsk lokalkunnskap",
    text: "Vi kjenner forholdene langs kysten og matcher kandidater som er vant til vær, vind og driftsmønster i nord.",
  },
];

const COMPLIANCE_POINTS = [
  "Bemanningsplaner utarbeides i tråd med Sjøfartsdirektoratets krav",
  "GDPR-vennlig behandling av persondata og avtaledokumenter",
  "Rapporterbare timelister og kontrakter levert digitalt",
  "Oppfølging av hviletid og sertifikatutløp i samarbeid med rederi",
];
...
const sx: Record<string, React.CSSProperties> = {
  ...
  sectionDeep: {
    padding: "48px 0",
    background: "linear-gradient(180deg, #0B1F3A 0%, #102851 100%)",
    color: "#E2E8F0",
  },
  sectionDeepIntro: {
    textAlign: "center",
  ...
  assureCard: {
    ...
    borderRadius: 16,
    padding: 20,
    boxShadow: "0 16px 40px rgba(5, 12, 32, 0.35)",
    backdropFilter: "blur(4px)",
  },
  assureIcon: { fontSize: 30, marginBottom: 12 },
  assureTitle: {
    fontWeight: 800,
    fontSize: 18,
    marginBottom: 8,
  ...
  assureText: { margin: 0, color: "#E2E8F0", lineHeight: 1.6, fontSize: 15 },
  complianceBox: {
    marginTop: 32,
