    ...
    <div style={sx.page}>
        ...
        <div style={sx.wrap}>
          ...
          >
            ...
            <div style={sx.logoBox}>
              ...
              <div style={sx.logoTag}>Maritim bemanning for hele verdikjeden</div>
            </div>
          </Link>
      ...
      <div style={sx.trustBand}>
        <div style={sx.trustRow}>
          ...
          <span>Bemanning for havbruk, fiskeri, logistikk og offshore</span>
        </div>
      </div>
          ...
          <div style={sx.footerGrid}>
            <div>
              ...
              <p style={sx.footerText}>
                Vi leverer erfarne sjøfolk til hele den maritime sektoren. Som tidligere mannskap kjenner vi tempoet og behovene
                langs norskekysten.
              </p>
            </div>
            <div>
