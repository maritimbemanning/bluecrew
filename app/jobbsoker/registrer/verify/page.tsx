...
export default function VerifyEmailPage({ searchParams }: { searchParams?: Record<string, string | string[] | undefined> }) {
      ...
      <main style={{ ...sx.main }}>
        <section style={sx.section}>
          <div style={sx.wrapNarrow}>
            <h1 style={sx.h2}>Bekreft e-post</h1>
            <p className="lead" style={{ ...sx.leadSmall, marginTop: 8 }}>
              Før du registrerer deg, må du bekrefte e-postadressen din. Vi sender en magisk lenke som logger deg inn.
            </p>
            ...
            <p style={{ marginTop: 14 }}>
              Allerede bekreftet? <Link href={returnTo} style={{ color: "#0ea5e9", textDecoration: "underline" }}>Gå videre</Link>
            </p>
          </div>
        </section>
      </main>
