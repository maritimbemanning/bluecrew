        ...
        <div style={sx.wrapNarrow}>
          ...
          <div id="overstyrsmann" style={{ marginTop: 56 }}>
            ...
            <div style={{ marginTop: 24, padding: 20, background: "#fef3c7", border: "1px solid #fbbf24", borderRadius: 12 }}>
              <p style={{ margin: 0, color: "#78350f", fontSize: 16, lineHeight: 1.6 }}>
                ...
                <Link href="/karriere/kaptein-lonn" style={{ color: "#0ea5e9", fontWeight: 700 }}> Les mer om kapteinlønn →</Link>
              </p>
            </div>
          </div>
          ...
          <div style={{ marginTop: 56, paddingTop: 32, borderTop: "1px solid #e2e8f0" }}>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              <Link href="/karriere/kaptein-lonn" style={{ 
                display: "block",
                padding: 20, 
                background: "#f8fafc", 
                borderRadius: 12, 
              ...
              <Link href="/jobbsoker/guides/hvordan-bli-matros" style={{ 
                display: "block",
                padding: 20, 
                background: "#f8fafc", 
                borderRadius: 12, 
              ...
              <Link href="/jobbsoker/guides/lonnsguide-maritime-stillinger" style={{ 
                display: "block",
                padding: 20, 
                background: "#f8fafc", 
                borderRadius: 12, 
