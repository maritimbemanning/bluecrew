...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/karriere/guides/hvordan-bli-maskinoffiser",
  },
};
        ...
        <div style={sx.wrapNarrow}>
          ...
          <div style={{ marginTop: 48 }}>
            ...
            <p style={{ marginTop: 20, fontSize: 15, color: "#64748b", fontStyle: "italic" }}>
              ...
              ligger midt på treet med god work-life balance. Se <Link href="/karriere/guides/lonnsguide-maritime-stillinger" style={{ color: "#0ea5e9", fontWeight: 600 }}>lønnsguiden</Link> for 
          ...
          <div style={{ marginTop: 48 }}>
            ...
            <div style={{ display: "grid", gap: 12 }}>
              <Link href="/karriere/guides/hvordan-bli-skipsforer" style={{ color: "#0ea5e9", textDecoration: "none", fontSize: 16, fontWeight: 600 }}>
                → Hvordan bli skipsfører
              </Link>
              <Link href="/karriere/guides/hvordan-bli-matros" style={{ color: "#0ea5e9", textDecoration: "none", fontSize: 16, fontWeight: 600 }}>
                → Hvordan bli matros
              </Link>
              <Link href="/karriere/guides/lonnsguide-maritime-stillinger" style={{ color: "#0ea5e9", textDecoration: "none", fontSize: 16, fontWeight: 600 }}>
                → Lønnsguide maritime stillinger 2025
              </Link>
              <Link href="/karriere/guides" style={{ color: "#0ea5e9", textDecoration: "none", fontSize: 16, fontWeight: 600 }}>
